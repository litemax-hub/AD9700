...
#define OD_L_LEN                                               0x0000400000
#define OD_L_MEMORY_TYPE                                       (MIU0 | SW | WRITE_BACK)

/* OD_R   */
//co_buffer L0
#define OD_R_AVAILABLE                                         0x0000F00000
#define OD_R_ADR                                               0x0000F00000  //Alignment 0
#define OD_R_GAP_CHK                                           0x0000000000
#define OD_R_LEN                                               0x0000400000
#define OD_R_MEMORY_TYPE                                       (MIU0 | SW | WRITE_BACK)

/* OSDC_L   */
//co_buffer L0
#define OSDC_L_AVAILABLE                                       0x0001300000
#define OSDC_L_ADR                                             0x0001300000  //Alignment 0
...
/* OSDC_R   */
//co_buffer L0
#define OSDC_R_AVAILABLE                                       0x0001300000
#define OSDC_R_ADR                                             0x0001300000  //Alignment 0
...
/* FB_L0   */
//co_buffer L0
#define FB_L0_AVAILABLE                                        0x0001300000
#define FB_L0_ADR                                              0x0001300000  //Alignment 0x02000
#define FB_L0_GAP_CHK                                          0x0000000000
#define FB_L0_LEN                                              0x0001600000
#define FB_L0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_R0   */
//co_buffer L0
#define FB_R0_AVAILABLE                                        0x0002900000
#define FB_R0_ADR                                              0x0002900000  //Alignment 0x02000
#define FB_R0_GAP_CHK                                          0x0000000000
#define FB_R0_LEN                                              0x0001600000
#define FB_R0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

//MIU_1_START
//MIU_END
#define MIU0_END_ADR                                           0x0003F00000
