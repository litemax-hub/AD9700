...
/* MENULOAD   */
//co_buffer L0
#define MENULOAD_AVAILABLE                                     0x0000A00000
#define MENULOAD_ADR                                           0x0000A00000  //Alignment 0
...
/* AUTOLOAD_OD   */
//co_buffer L0
#define AUTOLOAD_OD_AVAILABLE                                  0x0000A01000
#define AUTOLOAD_OD_ADR                                        0x0000A01000  //Alignment 0
...
/* AUTOLOAD_GMA   */
//co_buffer L0
#define AUTOLOAD_GMA_AVAILABLE                                 0x0000A21000
#define AUTOLOAD_GMA_ADR                                       0x0000A21000  //Alignment 0
...
/* MENULOAD_BUFFER   */
//co_buffer L0
#define MENULOAD_BUFFER_AVAILABLE                              0x0000A25000
#define MENULOAD_BUFFER_ADR                                    0x0000A25000  //Alignment 0
...
/* DOWNLOAD_BUFFER   */
//co_buffer L0
#define DOWNLOAD_BUFFER_AVAILABLE                              0x0000A29000
#define DOWNLOAD_BUFFER_ADR                                    0x0000A29000  //Alignment 0
...
/* FILE_SYSTEM_POOL   */
//co_buffer L0
#define FILE_SYSTEM_POOL_AVAILABLE                             0x0000C29000
#define FILE_SYSTEM_POOL_ADR                                   0x0000C29000  //Alignment 0x01000
...
/* MBX_XD2MIU   */
//co_buffer L0
#define MBX_XD2MIU_AVAILABLE                                   0x0000C89000
#define MBX_XD2MIU_ADR                                         0x0000C90000  //Alignment 0x10000
...
/* AudioPCM   */
//co_buffer L0
#define AudioPCM_AVAILABLE                                     0x0000CA0000
#define AudioPCM_ADR                                           0x0000CA0000  //Alignment 0
...
/* PQ_MAIN   */
//co_buffer L0
#define PQ_MAIN_AVAILABLE                                      0x00010A0000
#define PQ_MAIN_ADR                                            0x00010A0000  //Alignment 0
...
/* PQ_MAIN_EX   */
//co_buffer L0
#define PQ_MAIN_EX_AVAILABLE                                   0x0001104000
#define PQ_MAIN_EX_ADR                                         0x0001104000  //Alignment 0
...
/* PQ_TEXT_MAIN   */
//co_buffer L0
#define PQ_TEXT_MAIN_AVAILABLE                                 0x000110C000
#define PQ_TEXT_MAIN_ADR                                       0x000110C000  //Alignment 0
...
/* MS_TOOL   */
//co_buffer L0
#define MS_TOOL_AVAILABLE                                      0x0001114000
#define MS_TOOL_ADR                                            0x0001114000  //Alignment 0x01000
...
/* GOP_GWIN_RB   */
//co_buffer L0
#define GOP_GWIN_RB_AVAILABLE                                  0x0001314000
#define GOP_GWIN_RB_ADR                                        0x0001314000  //Alignment 0x00008
...
/* GOP_REGDMABASE   */
//co_buffer L0
#define GOP_REGDMABASE_AVAILABLE                               0x0002B14000
#define GOP_REGDMABASE_ADR                                     0x0002B14000  //Alignment 0x04000
...
/* POOL_BUFFER   */
//co_buffer L0
#define POOL_BUFFER_AVAILABLE                                  0x0002B15000
#define POOL_BUFFER_ADR                                        0x0002B80000  //Alignment 0x80000
...
/* BMP_START   */
//co_buffer L0
#define BMP_START_AVAILABLE                                    0x0004880000
#define BMP_START_ADR                                          0x0004880000  //Alignment 0x00800
...
//co_buffer L0
#define BMP_PALETTE_BUF_START_AVAILABLE                        0x0005280000
#define BMP_PALETTE_BUF_START_ADR                              0x0005280000  //Alignment 0
...
/* STRING_START   */
//co_buffer L0
#define STRING_START_AVAILABLE                                 0x0005280800
#define STRING_START_ADR                                       0x0005280800  //Alignment 0x00800
...
/* FONT_START   */
//co_buffer L0
#define FONT_START_AVAILABLE                                   0x00052D0800
#define FONT_START_ADR                                         0x00052D0800  //Alignment 0x00008
...
/* OD_L   */
//co_buffer L0
#define OD_L_AVAILABLE                                         0x00053B1800
#define OD_L_ADR                                               0x00053B1800  //Alignment 0
...
/* OD_R   */
//co_buffer L0
#define OD_R_AVAILABLE                                         0x00061B1800
#define OD_R_ADR                                               0x00061B1800  //Alignment 0
...
/* OSDC_L   */
//co_buffer L0
#define OSDC_L_AVAILABLE                                       0x0006FB1800
#define OSDC_L_ADR                                             0x0006FB1800  //Alignment 0
#define OSDC_L_GAP_CHK                                         0x0000000000
#define OSDC_L_LEN                                             0x0001400000
#define OSDC_L_MEMORY_TYPE                                     (MIU0 | SW | WRITE_BACK)

/* OSDC_R   */
//co_buffer L0
#define OSDC_R_AVAILABLE                                       0x00083B1800
#define OSDC_R_ADR                                             0x00083B1800  //Alignment 0
#define OSDC_R_GAP_CHK                                         0x0000000000
#define OSDC_R_LEN                                             0x0001400000
#define OSDC_R_MEMORY_TYPE                                     (MIU0 | SW | WRITE_BACK)

/* FB_L0   */
//co_buffer L0
#define FB_L0_AVAILABLE                                        0x00097B1800
#define FB_L0_ADR                                              0x00097B2000  //Alignment 0x02000
#define FB_L0_GAP_CHK                                          0x0000000800
#define FB_L0_LEN                                              0x0004400000
#define FB_L0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_R0   */
//co_buffer L0
#define FB_R0_AVAILABLE                                        0x000DBB2000
#define FB_R0_ADR                                              0x000DBB2000  //Alignment 0x02000
#define FB_R0_GAP_CHK                                          0x0000000000
#define FB_R0_LEN                                              0x0004400000
#define FB_R0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_L1   */
//co_buffer L0
#define FB_L1_AVAILABLE                                        0x0011FB2000
#define FB_L1_ADR                                              0x0011FB2000  //Alignment 0x02000
#define FB_L1_GAP_CHK                                          0x0000000000
#define FB_L1_LEN                                              0x0004400000
#define FB_L1_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_R1   */
//co_buffer L0
#define FB_R1_AVAILABLE                                        0x00163B2000
#define FB_R1_ADR                                              0x00163B2000  //Alignment 0x02000
#define FB_R1_GAP_CHK                                          0x0000000000
#define FB_R1_LEN                                              0x0004400000
#define FB_R1_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

//MIU_1_START
//MIU_END
#define MIU0_END_ADR                                           0x001A7B2000
