...
//------------------------------------------------------------------------------
  ...
  #if (CHIP_ID==MST9U4)
    #include "MMAP_MST9U4_256_256_AEON.h"
  #else
    #include "MMAP_MST9U_256_256_AEON.h"
  #endif
#elif ( MEMORY_MAP == MMAP_512_512MB )
    #include "MMAP_MST9U4_512_512_AEON.h"
#elif ( MEMORY_MAP == MMAP_1024_1024_1024MB )
    #include "MMAP_MST9U4_1024_1024_1024_AEON.h"
#elif ( MEMORY_MAP == MMAP_512_512_512MB )
    #include "MMAP_MST9U4_512_512_512_AEON.h"
#elif( MEMORY_MAP == MMAP_256_256_256MB )
    #include "MMAP_MST9U4_256_256_256_AEON.h"
#else
