...
#define AudioPCM_LEN                                           0x0000200000
#define AudioPCM_MEMORY_TYPE                                   (MIU0 | SW | WRITE_BACK)

/* PQ_MAIN   */
//co_buffer L0
#define PQ_MAIN_AVAILABLE                                      0x0000AA0000
#define PQ_MAIN_ADR                                            0x0000AA0000  //Alignment 0
...
/* PQ_MAIN_EX   */
//co_buffer L0
#define PQ_MAIN_EX_AVAILABLE                                   0x0000B04000
#define PQ_MAIN_EX_ADR                                         0x0000B04000  //Alignment 0
...
/* PQ_TEXT_MAIN   */
//co_buffer L0
#define PQ_TEXT_MAIN_AVAILABLE                                 0x0000B0C000
#define PQ_TEXT_MAIN_ADR                                       0x0000B0C000  //Alignment 0
...
/* MS_TOOL   */
//co_buffer L0
#define MS_TOOL_AVAILABLE                                      0x0000B14000
#define MS_TOOL_ADR                                            0x0000B14000  //Alignment 0x01000
...
/* GOP_GWIN_RB   */
//co_buffer L0
#define GOP_GWIN_RB_AVAILABLE                                  0x0000D14000
#define GOP_GWIN_RB_ADR                                        0x0000D14000  //Alignment 0x00008
#define GOP_GWIN_RB_GAP_CHK                                    0x0000000000
#define GOP_GWIN_RB_LEN                                        0x0000C00000
#define GOP_GWIN_RB_MEMORY_TYPE                                (MIU0 | SW | WRITE_BACK)

/* GOP_REGDMABASE   */
//co_buffer L0
#define GOP_REGDMABASE_AVAILABLE                               0x0001914000
#define GOP_REGDMABASE_ADR                                     0x0001914000  //Alignment 0x04000
...
/* POOL_BUFFER   */
//co_buffer L0
#define POOL_BUFFER_AVAILABLE                                  0x0001915000
#define POOL_BUFFER_ADR                                        0x0001980000  //Alignment 0x80000
#define POOL_BUFFER_GAP_CHK                                    0x000006B000
#define POOL_BUFFER_LEN                                        0x0001000000
#define POOL_BUFFER_MEMORY_TYPE                                (MIU0 | SW | WRITE_BACK)

/* BMP_START   */
//co_buffer L0
#define BMP_START_AVAILABLE                                    0x0002980000
#define BMP_START_ADR                                          0x0002980000  //Alignment 0x00800
#define BMP_START_GAP_CHK                                      0x0000000000
#define BMP_START_LEN                                          0x0000400000
#define BMP_START_MEMORY_TYPE                                  (MIU0 | SW | WRITE_BACK)

/* BMP_PALETTE_BUF_START   */
//co_buffer L0
#define BMP_PALETTE_BUF_START_AVAILABLE                        0x0002D80000
#define BMP_PALETTE_BUF_START_ADR                              0x0002D80000  //Alignment 0
...
/* STRING_START   */
//co_buffer L0
#define STRING_START_AVAILABLE                                 0x0002D80800
#define STRING_START_ADR                                       0x0002D80800  //Alignment 0x00800
...
/* FONT_START   */
//co_buffer L0
#define FONT_START_AVAILABLE                                   0x0002DD0800
#define FONT_START_ADR                                         0x0002DD0800  //Alignment 0x00008
...
/* OD_L   */
//co_buffer L0
#define OD_L_AVAILABLE                                         0x0002EB1800
#define OD_L_ADR                                               0x0002EB1800  //Alignment 0
#define OD_L_GAP_CHK                                           0x0000000000
#define OD_L_LEN                                               0x0000300000
#define OD_L_MEMORY_TYPE                                       (MIU0 | SW | WRITE_BACK)

/* OD_R   */
//co_buffer L0
#define OD_R_AVAILABLE                                         0x00031B1800
#define OD_R_ADR                                               0x00031B1800  //Alignment 0
#define OD_R_GAP_CHK                                           0x0000000000
#define OD_R_LEN                                               0x0000300000
#define OD_R_MEMORY_TYPE                                       (MIU0 | SW | WRITE_BACK)

/* OSDC_L   */
//co_buffer L0
#define OSDC_L_AVAILABLE                                       0x00034B1800
#define OSDC_L_ADR                                             0x00034B1800  //Alignment 0
#define OSDC_L_GAP_CHK                                         0x0000000000
#define OSDC_L_LEN                                             0x0000600000
#define OSDC_L_MEMORY_TYPE                                     (MIU0 | SW | WRITE_BACK)

/* OSDC_R   */
//co_buffer L0
#define OSDC_R_AVAILABLE                                       0x0003AB1800
#define OSDC_R_ADR                                             0x0003AB1800  //Alignment 0
#define OSDC_R_GAP_CHK                                         0x0000000000
#define OSDC_R_LEN                                             0x0000600000
#define OSDC_R_MEMORY_TYPE                                     (MIU0 | SW | WRITE_BACK)

/* FB_L0   */
//co_buffer L0
#define FB_L0_AVAILABLE                                        0x00040B1800
#define FB_L0_ADR                                              0x00040B2000  //Alignment 0x02000
#define FB_L0_GAP_CHK                                          0x0000000800
#define FB_L0_LEN                                              0x0000F00000
#define FB_L0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_R0   */
//co_buffer L0
#define FB_R0_AVAILABLE                                        0x0004FB2000
#define FB_R0_ADR                                              0x0004FB2000  //Alignment 0x02000
#define FB_R0_GAP_CHK                                          0x0000000000
#define FB_R0_LEN                                              0x0000F00000
#define FB_R0_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_L1   */
//co_buffer L0
#define FB_L1_AVAILABLE                                        0x0005EB2000
#define FB_L1_ADR                                              0x0005EB2000  //Alignment 0x02000
#define FB_L1_GAP_CHK                                          0x0000000000
#define FB_L1_LEN                                              0x0000F00000
#define FB_L1_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

/* FB_R1   */
//co_buffer L0
#define FB_R1_AVAILABLE                                        0x0006DB2000
#define FB_R1_ADR                                              0x0006DB2000  //Alignment 0x02000
#define FB_R1_GAP_CHK                                          0x0000000000
#define FB_R1_LEN                                              0x0000F00000
#define FB_R1_MEMORY_TYPE                                      (MIU0 | SW | WRITE_BACK)

//MIU_1_START
//MIU_END
#define MIU0_END_ADR                                           0x0007CB2000
