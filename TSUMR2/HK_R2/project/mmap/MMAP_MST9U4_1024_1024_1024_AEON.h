...
#define MIU_DRAM_LEN                0x00C0000000
#define MIU_DRAM_LEN0               0x0040000000
#define MIU_DRAM_LEN1               0x0040000000
#define MIU_DRAM_LEN2               0x0040000000
...
/* FB_MIU0   */
//co_buffer L0
#define FB_MIU0_AVAILABLE                                      0x000A7B2000
#define FB_MIU0_ADR                                            0x000A7B2000  //Alignment 0x02000
#define FB_MIU0_GAP_CHK                                        0x0000000000
#define FB_MIU0_LEN                                            0x0004600000
...
#define HDR_BUFFER0_LEN                                        0x0002000000
#define HDR_BUFFER0_MEMORY_TYPE                                (MIU1 | SW | WRITE_BACK)

/* HDR_BUFFER1   */
//co_buffer L0
#define HDR_BUFFER1_AVAILABLE                                  0x0002200000
#define HDR_BUFFER1_ADR                                        0x0002200000  //Alignment 0
#define HDR_BUFFER1_GAP_CHK                                    0x0000000000
#define HDR_BUFFER1_LEN                                        0x0002000000
#define HDR_BUFFER1_MEMORY_TYPE                                (MIU1 | SW | WRITE_BACK)

/* KST_BUFFER0   */
//co_buffer L0
#define KST_BUFFER0_AVAILABLE                                  0x0004200000
#define KST_BUFFER0_ADR                                        0x0004200000  //Alignment 0x100000
#define KST_BUFFER0_GAP_CHK                                    0x0000000000
#define KST_BUFFER0_LEN                                        0x0005000000
#define KST_BUFFER0_MEMORY_TYPE                                (MIU1 | SW | WRITE_BACK)

/* FB_MIU1   */
//co_buffer L0
#define FB_MIU1_AVAILABLE                                      0x0009200000
#define FB_MIU1_ADR                                            0x0009200000  //Alignment 0x02000
#define FB_MIU1_GAP_CHK                                        0x0000000000
#define FB_MIU1_LEN                                            0x0025800000
...
#define HDR_BUFFER2_LEN                                        0x0002000000
#define HDR_BUFFER2_MEMORY_TYPE                                (MIU2 | SW | WRITE_BACK)

/* HDR_BUFFER3   */
//co_buffer L0
#define HDR_BUFFER3_AVAILABLE                                  0x0002200000
#define HDR_BUFFER3_ADR                                        0x0002200000  //Alignment 0
#define HDR_BUFFER3_GAP_CHK                                    0x0000000000
#define HDR_BUFFER3_LEN                                        0x0002000000
#define HDR_BUFFER3_MEMORY_TYPE                                (MIU2 | SW | WRITE_BACK)

/* KST_BUFFER1   */
//co_buffer L0
#define KST_BUFFER1_AVAILABLE                                  0x0004200000
#define KST_BUFFER1_ADR                                        0x0004200000  //Alignment 0x100000
#define KST_BUFFER1_GAP_CHK                                    0x0000000000
#define KST_BUFFER1_LEN                                        0x0005000000
#define KST_BUFFER1_MEMORY_TYPE                                (MIU2 | SW | WRITE_BACK)

/* FB_MIU2   */
//co_buffer L0
#define FB_MIU2_AVAILABLE                                      0x0009200000
#define FB_MIU2_ADR                                            0x0009200000  //Alignment 0x02000
#define FB_MIU2_GAP_CHK                                        0x0000000000
#define FB_MIU2_LEN                                            0x0025800000
#define FB_MIU2_MEMORY_TYPE                                    (MIU2 | SW | WRITE_BACK)

//MIU_2_END

#define MIU0_END_ADR                                           0x000EDB2000
#define MIU1_END_ADR                                           0x002EA00000
#define MIU2_END_ADR                                           0x002EA00000
#define MMAP_COUNT                                             0x000000002C

#define TEST_4K_ALIGN                   1

/* CHK_VALUE = 2985335701 */
