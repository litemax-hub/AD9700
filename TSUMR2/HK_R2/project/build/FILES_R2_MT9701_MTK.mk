...
MONITOR_PATH_CUSTOM_MTK_CERT   = $(MONITOR_PATH_CUSTOM)/MTK_CERT
...
MONITOR_FILES_DRIVER  += \
        $(MONITOR_PATH_DRIVER)/9701/drvAdjust.c                            \
        $(MONITOR_PATH_DRIVER)/9701/drvMcu.c                               \
        $(MONITOR_PATH_DRIVER)/9701/msScaler.c                             \
        $(MONITOR_PATH_DRIVER)/9701/appmStar.c                             \
        $(MONITOR_PATH_DRIVER)/9701/drvmStar.c                             \
        $(MONITOR_PATH_DRIVER)/9701/msFB.c                                 \
        $(MONITOR_PATH_DRIVER)/9701/drvmsOVD.c                             \
        $(MONITOR_PATH_DRIVER)/9701/drvDAC.c                               \
        $(MONITOR_PATH_DRIVER)/9701/drvGamma.c                             \
        $(MONITOR_PATH_DRIVER)/9701/drvCEC.c                               \
        $(MONITOR_PATH_DRIVER)/9701/drvIMI.c                               \
        $(MONITOR_PATH_DRIVER)/9701/drvDeltaE.c                            \
        $(MONITOR_PATH_DRIVER)/9701/drv3DLUT_C.c                           \
        $(MONITOR_PATH_DRIVER)/9701/msACE.c                                \
        $(MONITOR_PATH_DRIVER)/9701/Adjust.c                               \
        $(MONITOR_PATH_DRIVER)/9701/AutoGamma.c                            \
        $(MONITOR_PATH_DRIVER)/9701/drvLutAutoDownload.c                   \
        ...
        $(MONITOR_PATH_DRIVER)/9701/apiHDR.c                                    \
        $(MONITOR_PATH_DRIVER)/9701/drvHDR.c                                    \
        $(MONITOR_PATH_DRIVER)/9701/drvHDRCommon.c                              \
        $(MONITOR_PATH_DRIVER)/9701/drvHDRLUT.c                                 \
        $(MONITOR_PATH_DRIVER)/9701/system_eDPTx.c                                 \
...
MONITOR_FILES_KERNEL_SCALER  += \
        ...
        $(MONITOR_PATH_DRIVER)/9701/mhal_DPRx.c     \
        $(MONITOR_PATH_DRIVER)/9701/mhal_DPRx_phy.c     \
        $(MONITOR_PATH_DRIVER)/9701/mdrv_DPRx.c     \
        $(MONITOR_PATH_DRIVER)/9701/mapi_DPRx.c     \
        $(MONITOR_PATH_DRIVER)/9701/mapi_eDPTx.c     \
        $(MONITOR_PATH_DRIVER)/9701/mdrv_eDPTx.c     \
        $(MONITOR_PATH_DRIVER)/9701/mhal_eDPTx.c     \
        $(MONITOR_PATH_DRIVER)/9701/mhal_hdmiRx.c     \
	$(MONITOR_PATH_DRIVER)/9701/mdrv_hdmiRx.c     \
        $(MONITOR_PATH_DRIVER)/9701/HDCP22/HdcpHandler.c     \
        $(MONITOR_PATH_DRIVER)/9701/HDCP22/HdcpLog.c     \
        $(MONITOR_PATH_DRIVER)/9701/HDCP22/HdcpMbx.c     \
        $(MONITOR_PATH_DRIVER)/9701/HDCP22/HdcpMsgPool.c     \
        $(MONITOR_PATH_DRIVER)/9701/HDCP22/HdcpRx.c     \
        $(MONITOR_PATH_DRIVER)/9701/HDCP22/HdcpTx.c     \
        $(MONITOR_PATH_DRIVER)/9701/HDCP22/drv_Hdcp_IMI.c                           \
        $(MONITOR_PATH_KERNEL_SCALER)/dri_table_gen_MT9701.c     \
...
MONITOR_FILES_KERNEL_SYSTEM  += \
        ...
        $(MONITOR_PATH_KERNEL_SYSTEM)/mailbox.c                \
         $(MONITOR_PATH_KERNEL_SYSTEM)/usbsw_MT9701.c     \
...
MONITOR_FILES_LIB_TTS  += \
	$(MONITOR_PATH_LIB_SRC)/TTS/Code/mTTS.c			\

MONITOR_FILES_LIB_AES  += \
         ...
         $(ROOT)/core/driver/sys/MST9U/mbedtls_2_3_0/programs/aes/aesdecrypt.c       \
...
MONITOR_LIB_TTS = $(MONITOR_PATH_LIB)/TTS.lib
...
MONITOR_LIB_AES  = $(MONITOR_PATH_LIB)/AES.lib
...
MONITOR_FILES_CUSTOM_MTK_CERT += \
        $(MONITOR_PATH_CUSTOM_MTK_CERT)/DDCMtkTestHandler.c                 \
...
MONITOR_FILES_INC += \
        ...
        -I$(MONITOR_PATH_DRIVER)/9701/INC                     \
        -I$(MONITOR_PATH_DRIVER)/9701/INC/HDMI                     \
        -I$(MONITOR_PATH_DRIVER)/9701/HDCP22/INC          \
        ...
        -I$(MONITOR_PATH)/BIN                                   \
        -I$(MONITOR_PATH_CUSTOM_MTK_CERT)/INC                                    \
#        -I$(MONITOR_PATH_DRIVER)/usb_host/source                            \
#        -I$(MONITOR_PATH_DRIVER)/usb_host                            \
