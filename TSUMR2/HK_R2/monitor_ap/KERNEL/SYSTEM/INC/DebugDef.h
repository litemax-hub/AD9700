...
#define UART_CMD_MS_BANK_H      (SIORxBuffer[1])
#define UART_CMD_MS_BANK_L      (SIORxBuffer[2])
#define UART_CMD_MS_REGINDEX    (SIORxBuffer[3])
#define UART_CMD_MS_REGDATA     (SIORxBuffer[4])
