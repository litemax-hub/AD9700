...
//_MSTARDEC_ void msDrvIGenTuning( void );
_MSTARDEC_ void mStar_ACOnInit(void);
_MSTARDEC_ void mStar_Init( BOOL bACon );
...
_MSTARDEC_ void ScalerReset( BYTE ucParam );
...
_MSTARDEC_ void mStar_ForceDeOnlyMode(BOOL bForce, BOOL bEn);
_MSTARDEC_ void mStar_EnableAutoNoSignal(Bool bEnable);
