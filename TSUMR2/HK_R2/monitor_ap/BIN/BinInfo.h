...
#define BIN_ID_CODE_SECU_R2  			0x0105  //~48KB     //@.\BIN\MT9701_SECU.bin
#else
#define BIN_ID_CODE_SECU_R2  			0x0101  //~64KB     //@.\BIN\MT9700_SECU.bin
#endif

#if ENABLE_USB_TYPEC
//Code: PD51
#if ENABLE_INTERNAL_CC
#define BIN_ID_CODE_PD51_ICC    	0x0102  //~128KB     //@.\BIN\PD51_ICC.bin
#else

#if (CHIP_ID == CHIP_MT9701)
#define BIN_ID_CODE_PD51		    0x0106  //~128KB     //@.\BIN\MT9701_PD51.bin
#elif (CHIP_ID == CHIP_MT9700)
#define BIN_ID_CODE_PD51		    0x0103  //~128KB     //@.\BIN\MT9700_PD51.bin
#endif
...
#if ENABLE_PQ_R2
#define BIN_ID_CODE_PQ_R2  			0x0104  //~64KB     //@.\BIN\PQR2.bin
#endif
