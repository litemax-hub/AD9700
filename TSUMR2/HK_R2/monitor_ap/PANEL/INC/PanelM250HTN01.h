...
#define PanelDCLK            356 // 74.25
#define PanelMaxDCLK      370 // 98
#define PanelMinDCLK       320 // 58.54
#define HV_OUTPUT_TYPE          HSRM_B

// FRC coding test panel
#define PanelVfreq          (1440)
#define PanelMaxVfreq   1480//610//(750+20) // 75Hz
#define PanelMinVfreq   1420//(500-20) // 50Hz
#endif
//=================================================================
