...
#include "HdcpIMI.h"//[MT9701]

//----------------------------------------------------------------------//
// defines
//----------------------------------------------------------------------//
#define DEF_IMI_HDCP_BASE_ADDR           0x40000000//0x90000000//0x80000000//[MT9701]0x90000000
//#define DEF_IMI_LENGTH              0x1800  // 6KB//[MT9701]0x2C00 // 11KB
//#define DEF_IMI_HDCP_BUFF_START_ADDR     0xD0001A00//0x90001A00//0x80001A00//[MT9701]0x90001A00
//#define DEF_IMI_HDCP_BUFF_SIZE           0x00000800
//#define DEF_SECU_IMI_BASE_ADDR      0x80000000//0x90000000//[MT9701]0x80000000
...
// macros
//----------------------------------------------------------------------//
#define IMIGetAddr(addr)            (0x40000000|(addr))//(0x90000000|(addr))
