...
typedef enum
{
    HDMI_HV_SYNC_P_CHECK = 0,
    HDMI_HV_SYNC_P_H_SYNC_REVERSE,
    HDMI_HV_SYNC_P_FINAL,
    HDMI_HV_SYNC_OTHER_FINAL,
    HDMI_HV_SYNC_FINISHED,
}HDMI_HV_SYNC_FSM;

typedef enum
{
    HDMI_V_SYNC_BOTH_ALIGHN = 0,
    HDMI_HV_SYNC_BOTH_UNALIGHN,
    HDMI_HV_SYNC_TAIL_UNALIGHN,
    HDMI_HV_SYNC_HEAD_UNALIGHN,
}HDMI_V_SYNC_STATUS;
#endif
