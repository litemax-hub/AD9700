...
#define DP_AUX_DELAY_TRAINING				0x7E0 // 168us delay reply
...
#define DPRX_PROGRAM_DPCD12_ENABLE			0
#define DPRX_PROGRAM_DPCD13_ENABLE			0
#define DPRX_PROGRAM_DPCD14_ENABLE			0
#define DPRX_PROGRAM_DPCD15_ENABLE			0

#define DPRX_XDATA_PROGRAM_DPCD0_ENABLE		DPRX_HDCP2_ENABLE
#define DPRX_XDATA_PROGRAM_DPCD1_ENABLE		DP_XDATA_PROGRAMMABLE_DPCD_MCCS // for PM mccs

#define DPRX_PROGRAM_DPCD0_ADDERSS			0xFFFFF // I2C 0x30
...
#define DPRX_PROGRAM_DPCD4_ADDERSS			0xFFFFF
...
#define DPRX_PROGRAM_DPCD8_ADDERSS			0x69000
...
#define DPRX_PROGRAM_DPCD12_ADDERSS			0xFFFFF
#define DPRX_PROGRAM_DPCD13_ADDERSS			0xFFFFF //0x00700
#define DPRX_PROGRAM_DPCD14_ADDERSS			0xFFFFF
#define DPRX_PROGRAM_DPCD15_ADDERSS			0xFFFFF

#define DPRX_XDATA_PROGRAM_DPCD0_ADDERSS	0x6921D
#define DPRX_XDATA_PROGRAM_DPCD1_ADDERSS	0x00037

#define DPRX_PROG_DPCD_MODE_OLD				0x0 // Write 16 bytes takes 760 ~ 870us // Read 16 bytes takes 710 ~ 810us
#define DPRX_PROG_DPCD_MODE_BURST			0x1 // Write 16 bytes takes 460 ~ 550us // Read 16 bytes takes 380 ~ 420us

#define DPRX_PROGRAMMABLE_DPCD_MODE			DPRX_PROG_DPCD_MODE_BURST

#define DPRX_PROG_DPCD_BURSTMODE_TIMEOUT	2000

#define DPRX_NATIVE_AUX_ONLY                0x0
#define DPRX_I2C_ONLY                		0x1
#define DPRX_I2C_AND_NATIVE_AUX             0x2
#define DPRX_POWERFUL1BYTE                  0x3

#define DPRX_PROGRAM_DPCD0_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
#define DPRX_PROGRAM_DPCD1_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
#define DPRX_PROGRAM_DPCD2_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
#define DPRX_PROGRAM_DPCD3_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
#define DPRX_PROGRAM_DPCD4_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
#define DPRX_PROGRAM_DPCD5_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
#define DPRX_PROGRAM_DPCD6_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
#define DPRX_PROGRAM_DPCD7_FUNC_SELECT  	DPRX_I2C_AND_NATIVE_AUX
...
#define IEEE_OUI_THIRD						0xE7
                                                ...
                                                //ASCII code
#define DEVICE_STRING_0             		0x4D//M
#define DEVICE_STRING_1             		0x54//T
#define DEVICE_STRING_2             		0x4B//K
...
typedef enum _DPRx_RIU_DPCD_TYPE
{
    DPRx_RIU_DPCD_Auto = 0,  // Auto set a value to PM or NPM DPCD register accroding to offline bit
    DPRx_RIU_DPCD_ForcePM = BIT0,  // Only set a value to PM DPCD register
    DPRx_RIU_DPCD_ForceNPM = BIT1,  // Only set a value to NPM DPCD register
}DPRx_RIU_DPCD_TYPE;
...
typedef enum _DPRx_PROGRAM_DPCD_TYPE
{
	...
	DPRx_PROGRAM_DPCD_12 = 12,
	DPRx_PROGRAM_DPCD_13 = 13,
	DPRx_PROGRAM_DPCD_14 = 14,
	DPRx_PROGRAM_DPCD_15 = 15,
...
typedef enum _DPRx_HDCP_REAUTH_STEP
{
	DPRx_HDCP_STEP0_IDLE             = 0x0,
	DPRx_HDCP_STEP1_INTEGRITYFAIL    = 0x1,
	DPRx_HDCP_STEP2_LOSELOCK         = 0x2,
	DPRx_HDCP_STEP3_HPDLONG          = 0x3,
	DPRx_HDCP_STEPMAX
}DPRx_HDCP_REAUTH_STEP;
...
BOOL mhal_DPRx_CRCChange(DPRx_ID dprx_id);
...
void mhal_DPRx_SetDPCDValueByRIU(DPRx_AUX_ID dprx_aux_id, DWORD ulDPCDAddress, BYTE ubValue, DPRx_RIU_DPCD_TYPE dp_riu_DPCD_type_id);
