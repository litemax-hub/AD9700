...
#define DPRX_CRC_STABLE_TIMER_CNT           50 // Unit: ms
#define DPRX_DPCD246_VALID_TIMER_CNT        400 // Unit: ms
#define DPRX_CRC_FRAME_CHECK_CNT	        6
...
#define DPRX_AUDIO_CheckVideoMute_CNT          200
#define DPRX_AUDIO_CheckAudioMute_CNT          200
...
typedef struct
{
    ...
    BOOL bHdcp14StartAuth:1;
    BOOL bHdcp22StartAuth:1;
    BOOL bHdcp22AuthinOffline:1;
    BYTE ucHDCPThreeStepReauth;
    WORD ucHDCPThreeStepReauthTimer;
    WORD usFastTrainUnLockTimer;
    BOOL usFastTrainUnLockCheck;    
    BOOL bHDCP22ReauthCheck:1;
...
typedef struct
{
    ...
    BYTE DPMISC0;
    BYTE DPMISC1;
    BYTE ucPacketLostCnt[DP_SDP_SEL_MAX];
    BYTE ucPacketTimer;
    DWORD ulPacketStatustoSys;
    DWORD ulInputPacketStatus;

    WORD usDPCD246StableTimer; // Unit: ms
    WORD usDPCD246OverwriteTimer; // Unit: ms
    BOOL bDPCD246StableTimerUpFlag;
...
BOOL mdrv_DPRx_GetPacketData(DPRx_ID dprx_id, WORD PacketReceiveType, BYTE *pucPacketData, BYTE ucPacketLength);
...
void mdrv_DPRx_HDCP14MapDPCDWrite(DPRx_ID dprx_id, BYTE ucAddress, BYTE ucLength, BYTE *pucData);
