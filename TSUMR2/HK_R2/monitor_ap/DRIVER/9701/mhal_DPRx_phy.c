...
BYTE glPHYtrainingMode = 0;

//-------------------------------------------------------------------------------------------------
//  Local Functions
//-------------------------------------------------------------------------------------------------
void ______FunctionMuxMode________(void);

//**************************************************************************
//  [Function Name]:
//                  mhal_DPRX_FunctionMuxMode()
//  [Description]
//					mhal_DPRX_FunctionMuxMode
//  [Arguments]:
//
...
{
	WORD usRegOffsetPHY3ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);

	if(bEnable == TRUE){

		msWrite2Byte(REG_DPRX_PHY3_24_L + usRegOffsetPHY3ByID, 0x003E); //for test lane atop[3] fail
		msWrite2Byte(REG_DPRX_PHY3_25_L + usRegOffsetPHY3ByID, 0x0000);
		msWrite2Byte(REG_DPRX_PHY3_26_L + usRegOffsetPHY3ByID, 0x0000);
		msWriteByte(REG_DPRX_PHY3_27_L + usRegOffsetPHY3ByID, 0x00);
	}
	else
	{
		msWrite2Byte(REG_DPRX_PHY3_24_L + usRegOffsetPHY3ByID, 0xFFFF);
		msWrite2Byte(REG_DPRX_PHY3_25_L + usRegOffsetPHY3ByID, 0xFFFF);
		msWrite2Byte(REG_DPRX_PHY3_26_L + usRegOffsetPHY3ByID, 0xFFFF);
		msWriteByte(REG_DPRX_PHY3_27_L + usRegOffsetPHY3ByID, 0xFF);
	}

	return;
}

void ______DellMode________(void);
//**************************************************************************
//  [Function Name]:
//                  mhal_DPRX_DellMode_Enable()
//  [Description]
//					mhal_DPRX_DellMode_Enable
//  [Arguments]:
//
...
{
	WORD usRegOffsetTransCTRLByID = DP_REG_OFFSET_TRANS_CTRL(dprx_phy_id);

	if(bEnable ==  TRUE){
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, BIT0|BIT4, BIT0|BIT4);
	}
	else
	{
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, 0x0, BIT0|BIT4);
	}
/*
	//swing adjustment, default: HBR RBR min=1, HBR3 HBR2 min=2
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_02_L + usRegOffsetPHY0ByID, BIT0, BIT0|BIT1); //RBR
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_02_L + usRegOffsetPHY0ByID, BIT4, BIT4|BIT5); //HBR
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_02_H + usRegOffsetPHY0ByID, BIT1, BIT0|BIT1); //HBR2
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_02_H + usRegOffsetPHY0ByID, BIT5, BIT4|BIT5); //HBR3

	//fast mode: lock without choosing best 5vp
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetPHY0ByID, 0x0, BIT5);

	//jump enable:jump sw1/pre2
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetPHY0ByID, BIT6, BIT6);

	//pk mode: choose sw/pre for PK
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetPHY0ByID, BIT7, BIT7); //PK enable
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_H + usRegOffsetPHY0ByID, BIT0|BIT1, BIT0|BIT1|BIT2); //PK num
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_H + usRegOffsetPHY0ByID, BIT4|BIT5, BIT4|BIT5|BIT6); //PK cnt
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_L + usRegOffsetPHY0ByID, BIT0, BIT0|BIT1); //sw0
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_L + usRegOffsetPHY0ByID, 0x0, BIT4|BIT5); //pre0
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_H + usRegOffsetPHY0ByID, BIT0, BIT0|BIT1); //sw1
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_H + usRegOffsetPHY0ByID, BIT4, BIT4|BIT5); //pre1
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_L + usRegOffsetPHY0ByID, BIT1, BIT0|BIT1); //sw2
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_L + usRegOffsetPHY0ByID, 0x0, BIT4|BIT5); //pre2
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_H + usRegOffsetPHY0ByID, BIT1, BIT0|BIT1); //sw3
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_H + usRegOffsetPHY0ByID, BIT4, BIT4|BIT5); //pre3
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_L + usRegOffsetPHY0ByID, BIT0|BIT1, BIT0|BIT1); //sw4
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_L + usRegOffsetPHY0ByID, 0x0, BIT4|BIT5); //pre4
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_H + usRegOffsetPHY0ByID, BIT0|BIT1, BIT0|BIT1); //sw5
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_H + usRegOffsetPHY0ByID, 0x0, BIT4|BIT5); //pre5

	//jump sw/pre
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_L + usRegOffsetPHY0ByID, BIT0, BIT0|BIT1); //jump_sw
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_L + usRegOffsetPHY0ByID, BIT5, BIT4|BIT5); //jump_pre
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_H + usRegOffsetPHY0ByID, BIT1, BIT0|BIT1); //jump_to_sw
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_H + usRegOffsetPHY0ByID, 0x0, BIT4|BIT5); //jump_to_pre

	//pk_force
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_L + usRegOffsetPHY0ByID, BIT0|BIT1, BIT0|BIT1); //force_sw
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_L + usRegOffsetPHY0ByID, 0x0, BIT4|BIT5); //force_pre

	//ach sw/pre
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_H + usRegOffsetPHY0ByID, BIT1, BIT0|BIT1); //ach_sw
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_H + usRegOffsetPHY0ByID, BIT4, BIT4|BIT5); //ach_pre
*/
	return;
}
...
void mhal_DPRx_DellMode_FastModeEnable(DPRx_PHY_ID dprx_phy_id, BOOL bEnable)
{
	...
	if(bEnable == TRUE)
	{
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, BIT5, BIT5);

	}
	else
	{
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, 0x0, BIT5);
	}
...
void mhal_DPRx_DellMode_JmumpModeEnable(DPRx_PHY_ID dprx_phy_id, BOOL bEnable, BYTE swing, BYTE preemphasis, BYTE to_swing, BYTE to_preemphasis)
{
	...
	if(bEnable == TRUE)
	{
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, BIT6, BIT6);

		msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_L + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //jump_sw
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_L + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //jump_pre

		msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_H + usRegOffsetTransCTRLByID, to_swing, BIT0|BIT1); //jump_to_sw
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_06_H + usRegOffsetTransCTRLByID, to_preemphasis, BIT4|BIT5); //jump_to_pre
	}
	else
	{
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, 0x0, BIT6);
	}
...
void mhal_DPRx_DellMode_PKModeEnable(DPRx_PHY_ID dprx_phy_id, BOOL bEnable, BYTE stage, BYTE swing, BYTE preemphasis)
{
	...
	if(bEnable == TRUE)
	{
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, BIT7, BIT7); //PK enable

		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_H + usRegOffsetTransCTRLByID, BIT0|BIT1, BIT0|BIT1|BIT2); //PK num
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_H + usRegOffsetTransCTRLByID, BIT4|BIT5, BIT4|BIT5|BIT6); //PK cnt

		switch(stage)
        {
        	case 0 :
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_L + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //reg_5vp_eq_sw0
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_L + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //reg_5vp_eq_pre0
				break;
			case 1 :
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_H + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //reg_5vp_eq_sw1
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_03_H + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //reg_5vp_eq_pre1
				break;
			case 2 :
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_L + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //reg_5vp_eq_sw2
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_L + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //reg_5vp_eq_pre2
				break;
			case 3 :
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_H + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //reg_5vp_eq_sw3
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_04_H + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //reg_5vp_eq_pre3
				break;

			case 4 :
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_L + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //reg_5vp_eq_sw4
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_L + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //reg_5vp_eq_pre4
				break;
			case 5 :
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_H + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //reg_5vp_eq_sw5
				msWriteByteMask(REG_DPRX_TRANS_CTRL1_05_H + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //reg_5vp_eq_pre5
				break;
			default:
				break;
		}
	...
	{
		msWriteByteMask(REG_DPRX_TRANS_CTRL1_01_L + usRegOffsetTransCTRLByID, 0x0, BIT7); //PK disable
	}
...
void mhal_DPRx_DellMode_PKforceSetting(DPRx_PHY_ID dprx_phy_id, BYTE swing, BYTE preemphasis)
{
	...
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_L + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //force_sw
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_L + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //force_pre
...
void mhal_DPRx_DellMode_ACHSetting(DPRx_PHY_ID dprx_phy_id, BYTE swing, BYTE preemphasis)
{
	...
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_H + usRegOffsetTransCTRLByID, swing, BIT0|BIT1); //ach_sw
	msWriteByteMask(REG_DPRX_TRANS_CTRL1_07_H + usRegOffsetTransCTRLByID, preemphasis, BIT4|BIT5); //ach_pre
...
void mhal_DPRx_Switch_Training_Setting(DPRx_PHY_ID dprx_phy_id, BYTE link_rate)
{
    ...
    WORD usRegOffsetPHY1ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);
	...
	if(dprx_phy_id == 0x0)
	{
		glPHYtrainingMode = 1; //partial hardware mode
	}
#endif

	switch(glPHYtrainingMode)
	{
...
void mhal_DPRx_MuxSelect(DPRx_ID dprx_id, DPRx_AUX_ID dprx_aux_id)
{
    ...
    msWriteByteMask(REG_DPRX_PM_TOP_12_L, dprx_aux_id, BIT0|BIT1|BIT2); // Port select pm to non-pm

		//Russell2 SETTING3 setting
...
void mhal_DPRx_PHYInitialSetting(DPRx_ID dprx_id, DPRx_PHY_ID dprx_phy_id)
{
    ...
    WORD usRegOffsetPHY0ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);
    WORD usRegOffsetPHY1ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);
    WORD usRegOffsetPHY2ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);
    WORD usRegOffsetPHY3ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);
	...
	// rterm
    msWriteByteMask(REG_DPRX_PHY_PM_03_H + usRegOffset40ByID, 0, BIT4|BIT5);
...
//wriu     0x162232             0x2a
    ...
    if(dprx_phy_id==0)
    {
        ...
        //		Rterm efuse
        //=================================================================================
        // from efuse table confirm by Chunyu Chiang
        if(msEread_GetDataFromEfuse(0x13A)&BIT(4))
        {
            msWriteByteMask(REG_DPRX_PHY_PM_03_L, (msEread_GetDataFromEfuse(0x139)&0x0f), 0x0F );
            msWriteByteMask(REG_DPRX_PHY_PM_23_L, (msEread_GetDataFromEfuse(0x139)&0x0f), 0x0F );
        }
    	...
    	// needed by OG 2022/12/16
        if(msEread_GetDataFromEfuse(0x13A)&BIT(7))
        {
    ...
    {
        if(msEread_GetDataFromEfuse(0x138)&BIT(0))
        {
...
#if 0//(SET_DPC_PORT_AS_DP_PORT == 0x1)//DP TO DPC
    if(ubTemp2==0)//Note. this is Version1
    {
        //msWriteByte(REG_DPRX_PHY0_00_L, 0xE1); //Howard swap
...
#endif
    Current_rate[(BYTE)dprx_phy_id] = 0x14;
		//Russell2 SETTING3 setting
...
void mhal_DPRx_SetPHYLaneSwapEnable(DPRx_ID dprx_id, DPRx_PHY_ID dprx_phy_id, BOOL bEnable, BYTE ubTargetLaneNumber)
{
    ...
    if(bEnable == TRUE)
    {
        ...
        msWriteByte(REG_DPRX_TRANS_CTRL_2C_L + usRegOffsetTransCTRLByID, ubTargetLaneNumber); //SQH lane swap need follow phy lane swap
    }
    else
    {
        //default:
        ...
        msWriteByte(REG_DPRX_TRANS_CTRL_2C_L + usRegOffsetTransCTRLByID, 0);
    }
...
void mhal_DPRx_SetPHYPRBS7PNSwapEnable(DPRx_PHY_ID dprx_phy_id, BYTE ubLanePNSwapSelect )
{
    ...
    msWriteByteMask(REG_DPRX_PHY0_5E_H + usRegOffsetPHY0ByID, ubLanePNSwapSelect, BIT4|BIT5|BIT6|BIT7 );
...
{
	DWORD usRegOffsetPhy2ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);
...
{
    WORD usRegOffsetPHY1ByID = DP_REG_OFFSET_PHY0(dprx_phy_id);
    WORD usRegOffset40ByID = ((dprx_id) * 0x040);
    ...
    else if(dprx_phy_id == 0)
    {
        ...
        {
            case DP_ePM_POWERON:
                if(dprx_id < DPRx_ID_2) // Except DPC, DPC's R-term and SQH control is in USB register banks
                {
