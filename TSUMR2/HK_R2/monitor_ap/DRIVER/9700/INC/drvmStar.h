...
#endif
_DRVMSTARDEC_ void msDrvMODBiasConCal(void);
...
#define WaitOutputFpllStable()  {SetTimOutConter(FRAMEPLL_TIMEOUT);while(((msRead2Byte(REG_LPLL_54)&0x1F4) !=0x1F4 )&& (bTimeOutCounterFlag));}//if(!DDCCI_MCCS_CMD_FLAG) {g_u16u16DelayCounter=5000;while(!(msRead2Byte(REG_3854)==0x1F4) && (g_u16u16DelayCounter));}
...
_DRVMSTARDEC_ BYTE msDrvSetFrameDivider( BYTE vfreq_N );
