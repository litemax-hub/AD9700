...
#define    IDX_MCU_CLK_345MHZ    0
#define    IDX_MCU_CLK_288MHZ    1
#define    IDX_MCU_CLK_216MHZ    2
#define    IDX_MCU_CLK_172MHZ    3
#define    IDX_MCU_CLK_144MHZ    4
#define    IDX_MCU_CLK_108MHZ    5
...
#define SetUSBDL()       (msWriteByte(REG_10181A, 0x00),msWriteByte(REG_10181A, 0x01))
        ...
        #error "--------------------default SPI_MODE need to be set to SPI_MODE_SADD or higher--------------------"
    #endif
#endif
...
extern void mcuSetSlowClkSpeed(BYTE u8SlowClkDiv);
