...
// IMI MAP
//----------------------------------------------------------------------//
#define DEF_IMI_BASE_ADDR           0x90000000
...
#define DEF_IMI_ADL_SIZE            0x4400  // 17KB
...
#define USB_HOST_BUFFER_AVAILABLE                         ((DWORD)DEF_IMI_USB_START_ADDR)
#define USB_HOST_BUFFER_ADR                                    ((DWORD)DEF_IMI_USB_START_ADDR)  //Alignment 0x020
...
#define FILE_SYSTEM_POOL_ADR                                    ((DWORD)(USB_HOST_BUFFER_AVAILABLE+USB_HOST_BUFFER_LEN))  //Alignment 0x01000
...
#define DOWNLOAD_BUFFER_ADR                                   ((DWORD)(FILE_SYSTEM_POOL_AVAILABLE+FILE_SYSTEM_POOL_LEN))//Alignment 0x01000
#define DOWNLOAD_BUFFER_GAP_CHK                           0x0000000000
#define DOWNLOAD_BUFFER_LEN                                   (DEF_IMI_USB_SIZE - USB_HOST_BUFFER_LEN - FILE_SYSTEM_POOL_LEN)   // 928KB-24KB-320KB  //0x00098000//0x0000800000
