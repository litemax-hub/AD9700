...
extern unsigned char msReadByte( unsigned long u32Reg );
extern void msWriteByte( unsigned long u32Reg, unsigned char u8Val );
extern WORD msRead2Byte( DWORD u32RegLoAddr );
extern void msWrite2Byte( DWORD u32RegLoAddr, WORD u16Value );

#define USB_REG_WRITE8(r,v)    msWriteByte(otgRegAddress+r, v)//(DRC_OUT8(otgRegAddress + (r),(v)))
#define USB_REG_WRITE16(r,v)   msWrite2Byte(otgRegAddress+r, v)//(DRC_OUT16(otgRegAddress + (r),(v)))
#define USB_REG_READ8(r)    msReadByte(otgRegAddress+r)//(DRC_IN8(otgRegAddress + (r)))
#define USB_REG_READ16(r)     msRead2Byte(otgRegAddress+r)//(DRC_IN16(otgRegAddress + (r)))
...
#define USB_Read_RxCount()   USB_REG_READ16(0x128);//USB_REG_READ16(M_REG_RXCOUNT);
