#ifndef __BD_MTV19071_A2V1__
#define __BD_MTV19071_A2V1__
...
#define MIIC0_ENABLE            MIIC0_0_ENABLE
...
#define hwDVI0Cable_Pin                 (!((((((255ul*180)/330) < KEYPAD_SAR03) && (KEYPAD_SAR03 < ((255ul*220)/330))) || (KEYPAD_SAR03 < ((255ul*145)/330)))?TRUE:FALSE))
#define Init_hwDVI0Cable_Pin()          (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT3))
#define CABLE_DET_DVI0_SAR              SAR3_EN
#else
...
#define hwSDM_AuxN_DP1Pin_Pin           (KEYPAD_SAR02 >= ((255ul*200)/330)? TRUE : FALSE)  // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP1_SDMPin()            MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT2)
#define DC_SDM_DET_DP1_SAR              SAR2_EN

#define hwGNDDP1_Pin				    ((KEYPAD_SAR03 > ((255ul*183)/330))  ? TRUE : FALSE)
#define Init_hw_DP1_GNDPin()            (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT3))
#define DC_DPCable_DET_DP1_SAR          SAR3_EN
#define Init_hw_DP1_PWRPin()            (MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X1_OUT, TRUE, BIT1))
#else
...
#define hwSDM_AuxN_DP2Pin_Pin           (GETBIT(msReadByte(_REG_GPIO_DPC_IN), 0)) // PAD_GPIO_DPC0, For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP2_SDMPin()		    (msWriteByteMask(_REG_GPIO_DPC_OEZ, BIT0, BIT0)) //PAD_GPIO_DPC0 OEN control
#define DC_SDM_DET_DP2_SAR              0
 
#define hwGNDDP2_Pin                    (GETBIT(msReadByte(_REG_GPIO_DPC_IN), 1))
#define Init_hw_DP2_GNDPin()            (msWriteByteMask(_REG_GPIO_DPC_OEZ, BIT1, BIT1)) //PAD_GPIO_DPC1 OEN control
#define DC_DPCable_DET_DP2_SAR          0
#define Init_hw_DP2_PWRPin()            (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, TRUE, BIT2))
#else
...
#define CABLE_DET_SAR_EN                (CABLE_DET_VGA_SAR|CABLE_DET_DVI2_SAR|DC_SDM_DET_DP1_SAR|DC_DPCable_DET_DP1_SAR|DC_SDM_DET_DP2_SAR|DC_DPCable_DET_DP2_SAR)
#define CABLE_DET_SAR                   0
#define CABLE_DET_SAR2_EN               (DC_SDM_DET_DP1_SAR|DC_DPCable_DET_DP1_SAR|DC_SDM_DET_DP2_SAR|DC_DPCable_DET_DP2_SAR)
...
#if ENABLE_ARC
#define ARC_PORT                       Input_HDMI_C1 // Input_Digital
#endif
...
#define HDMI_Cable5v_2        1
...
#if ENABLE_HDCP
    #if(!HPD_INVERSE)
        #define hw_Set_HdcpHpd()        (MEM_MSWRITE_BIT(REG_PAD_TOP_40_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_40_H, TRUE, BIT2))
        #define hw_Clr_HdcpHpd()        (MEM_MSWRITE_BIT(REG_PAD_TOP_40_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_40_H, FALSE, BIT2))
        #define hwHDCP_Hpd_Pin()        (MEM_MSREAD_BYTE(REG_PAD_TOP_41_L) & BIT2)
    ...
    #else
        #define hw_Set_HdcpHpd()        (MEM_MSWRITE_BIT(REG_PAD_TOP_40_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_40_H, FALSE, BIT2))
        #define hw_Clr_HdcpHpd()        (MEM_MSWRITE_BIT(REG_PAD_TOP_40_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_40_H, TRUE, BIT2))
        #define hwHDCP_Hpd_Pin()        (!(MEM_MSREAD_BYTE(REG_PAD_TOP_41_L) & BIT2))
        #define hw_Set_HdcpHpd2()        // no use in this Board.
        #define hw_Clr_HdcpHpd2()       
        #define hwHDCP_Hpd2_Pin()
        ...
        #define hwHDCP_Hpd3_Pin()
    #endif
        #define Init_hwHDCP_Hpd_Pin()           (MEM_MSWRITE_BIT(REG_PAD_TOP_0B_H, FALSE, BIT0), MEM_MSWRITE_BYTE_MASK(REG_PAD_TOP_4C_H, BIT2|BIT3, BIT2|BIT3))
    #define Init_hwHDCP_Hpd_Pin2()      //TBD
...
#define DPRx_C2_AUX					AUX_GPIO_12_13_14
#define DPRx_C3_AUX					AUX_GPIO_DPC_3_4_5
#define DPRx_C4_AUX					AUX_None

#define SET_DPC_PORT_AS_DP_PORT		1 // If CInput_Displayport_C3 is not equal to CInput_Nothing, this should set to 1
