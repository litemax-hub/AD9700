#ifndef __BD_MTV19071__
#define __BD_MTV19071__
...
#define hwBlacklit_Pin          //GPIO_DPC1  //Driving Non-LED BL Module
#define hwPanel_Pin             //GPIOL7
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, 0, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, BIT1, BIT1), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, 0, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, 0, BIT1), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, 0, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, BIT1, BIT1))
...
#define hwGNDDP2_Pin                    ((((KEYPAD_SAR07 > ((255ul*206)/330)) && (KEYPAD_SAR07 < ((255ul*271)/330))) || (KEYPAD_SAR07 < ((255ul*172)/330)))? FALSE : TRUE)
...
#define hwSDM_AuxN_TYPEC4Pin_Pin        (GETBIT(msReadByte(REG_000492), 0))     // For Aux N detect, TRUE: connected, FALSE: not connected
#define hwSDM_AuxP_TYPEC4Pin_Pin        (GETBIT(msReadByte(REG_000492), 5))     // For Aux N detect, TRUE: connected, FALSE: not connected
...
#define CABLE_DET_SAR2_EN               (CABLE_DET_DVI0_SAR|CABLE_DET_DVI1_SAR|CABLE_DET_DVI2_SAR|CABLE_DET_DVI3_SAR)\
                                        |(DC_SDM_DET_DP2_SAR|DC_DPCable_DET_DP2_SAR)\
                                        |(DC_SDM_DET_TYPEC4_SAR)
...
#define hw_Set_TYPEC_B_AUX_TRI()         (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT2))
#define hw_Clr_TYPEC_B_AUX_TRI()         (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT2))
#define Init_TYPEC_B_AUX_TRI()           (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT2))  //set output mode, set Low
...
#define hw_SetUSB5V()                    (MEM_MSWRITE_BIT(_REG_GPIOL0_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIOL0_OEZ, FALSE, BIT2))  //GPIOL2 as USB_OTG_EN
