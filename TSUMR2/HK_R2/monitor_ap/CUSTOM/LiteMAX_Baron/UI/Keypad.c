			...
			ExecuteKeyEvent(MIA_Exit);
                ...
                if( keypadStatus == KEY_PLUS )
                {
                    ...
                    else
                    {
						...
						KEYPAD_printMsg("KeypadButton == BTN_Plus \n");
                    }
                }
                else if( keypadStatus == KEY_MINUS )
                {
                    ...
                    else
                    {
						...
						KEYPAD_printMsg("KeypadButton == BTN_Minus \n");
                    }
                }
                else if( keypadStatus == KEY_MENU )
                {
                    ...
                    else
                    {
						...
						KEYPAD_printMsg("KeypadButton == BTN_Menu \n");
                    }
                }
                else if( keypadStatus == KEY_EXIT )
                {
                    ...
                    else
                    {
...
#endif
                        {
							...
							KEYPAD_printMsg("KeypadButton == BTN_Exit \n");
                        }
                    }
                }
                    ...
                    //2006-02-22
                {
                    ...
                    else
                    {
						...
						KEYPAD_printMsg("KeypadButton == BTN_Select \n");
                    }
                }
