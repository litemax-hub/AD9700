...
extern BYTE *ChipNameText( void );
extern BYTE *BacklightHoursText( void );
extern BYTE *SpreadSpectrumText( void );
extern BYTE *FExitText( void );
extern BYTE *FreqText( void );
extern BYTE *AmpText( void );
extern BYTE *EDIDWPText( void );
extern BYTE *DDCWPOnOffText( void );
extern BYTE *ProductionText( void );
extern BYTE *ProductionOnOffText( void );
