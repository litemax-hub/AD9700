...
BYTE code strUSBC_InputM10[1][2]=
{ { 0x82, 0x07},
};

BYTE code strAutoColorProcessM11[1][2]=
{ { 0x20 , 0x0B }
};
...
BYTE code strAutoColorM101[1][2]=
{ { 0x98, 0x06},
};
...
BYTE code strAutoAdjustM105[1][2]=
{ { 0xC8, 0x07},
};
...
BYTE code strAudioSourceM106[1][2]=
{ { 0xA6, 0x08},
};
BYTE code strAudioSourceLineInM106[1][2]=
{ { 0xAE, 0x04},
};
BYTE code strAudioSourceDigitalM106[1][2]=
{ { 0xB2, 0x03},
};
...
BYTE code strDisplayLogoM106[1][2]=
{ { 0xE7, 0x07},
};
BYTE code strOtherSettingOnM106[1][2]=
{ { 0xEE, 0x02},
};
BYTE code strOtherSettingOffM106[1][2]=
{ { 0xF0, 0x02},
};
...
BYTE code strColorRangeM108[1][2]=
{ { 0x80 , 0x07 }
};
BYTE code strIndependentHueM108[1][2]=
{ { 0x87 , 0x0A }
};
BYTE code strIndependentSaturationM108[1][2]=
{ { 0x91 , 0x0D }
};
BYTE code strIndependentBrightnessM108[1][2]=
{ { 0x9E , 0x0D }
};
BYTE code strFullM108[1][2]=
{ { 0xAB , 0x02 }
};
BYTE code strLimitM108[1][2]=
{ { 0xAD , 0x03 }
};
BYTE code strAutoM108[1][2]=
{ { 0xB0 , 0x03 }
};
BYTE code strRM108[1][2]=
{ { 0xB3 , 0x01 }
};
BYTE code strGM108[1][2]=
{ { 0xB4 , 0x01 }
};
BYTE code strBM108[1][2]=
{ { 0xB5 , 0x01 }
};
BYTE code strYM108[1][2]=
{ { 0xB6 , 0x01 }
};
BYTE code strMM108[1][2]=
{ { 0xB7 , 0x01 }
};
BYTE code strCM108[1][2]=
{ { 0xB8 , 0x01 }
};

BYTE code strPowerSavingM109[1][2]=
{ { 0x80, 0x08},
};
BYTE code strDCOffDischargeM109[1][2]=
{ { 0x88, 0x0A},
};
BYTE code strPowerManagerOnM109[1][2]=
{ { 0x92, 0x02},
};
