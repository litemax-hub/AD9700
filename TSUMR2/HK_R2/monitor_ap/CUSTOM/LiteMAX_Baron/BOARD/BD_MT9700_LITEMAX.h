...
//PWM
#define BrightnessPWM           _PWM7_GP0_ // Driving Non-LED BL Module
...
#define hwBlacklit_Pin          //GPIO21
#define hwPanel_Pin             //GPIO20
...
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIOL1_OUT, 1, BIT2), MEM_MSWRITE_BIT(_REG_GPIOL1_OEZ, 0, BIT2)) // output enable

#define hw_SetPanel()           MEM_MSWRITE_BIT(_REG_GPIOL1_OUT, 1, BIT0)
#define hw_ClrPanel()           MEM_MSWRITE_BIT(_REG_GPIOL1_OUT, 0, BIT0)
#define Init_hwPanel_Pin()      (MEM_MSWRITE_BIT(_REG_GPIOL1_OUT, 0, BIT0), MEM_MSWRITE_BIT(_REG_GPIOL1_OEZ, 0, BIT0)) // output enable

//================================================================================================================
//================================================================================================================
#define Init_PCB_POWER_SW()       (MEM_MSWRITE_BIT(_REG_GPIO0_OUT, 1, BIT1), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, 0, BIT1))
...
#else
#define hwDSUBCable_Pin                 (_bit4_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))  //SAR3
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT4))
#define CABLE_DET_VGA_SAR               0
#endif


#if (CInput_HDMI_C1!=CInput_Nothing)||(CInput_DVI_C1!=CInput_Nothing)
#define hwDVI0Cable_Pin                 (_bit2_(MEM_MSREAD_BYTE(_REG_GPIO5_IN)))//(KEYPAD_SAR06)
#define Init_hwDVI0Cable_Pin()          (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT2))//(MEM_MSWRITE_BIT(REG_3A68,1,BIT6)) // Enable SAR ch
...
#define hwSDM_AuxN_DP1Pin_Pin           (_bit3_(MEM_MSREAD_BYTE(_REG_GPIO5_IN))) // detect AUX_N
#define Init_hw_DP1_SDMPin()		    (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT3))
...
#define hwSDM_AuxN_DP2Pin_Pin           (_bit3_(MEM_MSREAD_BYTE(_REG_GPIO5_IN))) // detect AUX_N
#define Init_hw_DP2_SDMPin()            (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, 1, BIT3))
...
#define hw_SetGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT2);}
#define hw_ClrGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT2);}
...
#define HDMI_Rx2               HDMI_DDC_0 //no this port in this board

//Check each HDMI5v is connected to IC or not
//If there is no HDMI5v connection to IC please set these define to 0
#define HDMI_Cable5v_0        0
#define HDMI_Cable5v_1        0
#define HDMI_Cable5v_2        0

#if ENABLE_HDCP
    #if(!HPD_INVERSE)
        #define hw_Set_HdcpHpd()        (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6))
        #define hw_Clr_HdcpHpd()        (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6))
        #define hwHDCP_Hpd_Pin()        (MEM_MSREAD_BYTE(_REG_GPIO3_IN) & BIT6)
        ...
        #define hwHDCP_Hpd3_Pin() 
    #endif
    #define Init_hwHDCP_Hpd_Pin()   (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6), MEM_MSWRITE_BYTE_MASK(REG_PAD_TOP_4B_L, BIT6|BIT7, BIT6|BIT7))
...
#define KEYPAD_ADC_A    KEYPAD_SAR01
#define KEYPAD_ADC_B    KEYPAD_SAR02
