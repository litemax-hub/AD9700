#ifndef __BD_MTV19067__
#define __BD_MTV19067__
...
#define DFT_MUX_Uart0           UART_GPIO32_33 // default mux uart 0 - VGA
...
#define PM_POWERKEY_WAKEUP      (GPIO21_INT | GPIO20_INT | GPIO26_INT | GPIO00_INT | GPIO01_INT | GPIO24_INT | GPIO27_INT | GPIO30_INT | GPIO31_INT | GPIO36_INT | GPIO37_INT | GPIO02_INT | GPIO11_INT | GPIO50_INT |GPIO51_INT)
...
#define hwBlacklit_Pin          //GPIO12  //Driving Non-LED BL Module
#define hwPanel_Pin             //GPIO00
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO1_OEZ, 0, BIT2), MEM_MSWRITE_BIT(_REG_GPIO1_OUT, BIT2, BIT2), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO1_OEZ, 0, BIT2), MEM_MSWRITE_BIT(_REG_GPIO1_OUT, 0, BIT2), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIO1_OEZ, 0, BIT2), MEM_MSWRITE_BIT(_REG_GPIO1_OEZ, BIT2, BIT2))
...
#define hwDSUBCable_Pin                 (!((KEYPAD_SAR02 < ((255ul*180)/330))?TRUE:FALSE))
#define Init_hwDSUBCable_Pin()          (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT2))
#define CABLE_DET_VGA_SAR               SAR2_EN
#else
...
#define hwDVI0Cable_Pin                 (!((((((255ul*180)/330) < KEYPAD_SAR02) && (KEYPAD_SAR05 < ((255ul*220)/330))) || (KEYPAD_SAR02 < ((255ul*145)/330)))?TRUE:FALSE))
#define Init_hwDVI0Cable_Pin()          (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT2))
#define CABLE_DET_DVI0_SAR              SAR2_EN
#else
...
#define hwSDM_AuxN_DP1Pin_Pin           (KEYPAD_SAR03 >= ((255ul*200)/330)? TRUE : FALSE)  // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP1_SDMPin()            MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT3)
#define DC_SDM_DET_DP1_SAR              SAR3_EN
#define hwGNDDP1_Pin                    ((((KEYPAD_SAR05 > ((255ul*206)/330)) && (KEYPAD_SAR05 < ((255ul*271)/330))) || (KEYPAD_SAR05 < ((255ul*172)/330)))? FALSE : TRUE)
#define Init_hw_DP1_GNDPin()            (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT5))
#define DC_DPCable_DET_DP1_SAR          SAR5_EN
#define Init_hw_DP1_PWRPin()            (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT0))
#else
...
#define hwSDM_AuxN_DP2Pin_Pin           (KEYPAD_SAR07 >= ((255ul*200)/330)? TRUE : FALSE)  // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP2_SDMPin()            MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT7)
#define DC_SDM_DET_DP2_SAR              SAR7_EN
#define hwGNDDP2_Pin                    (KEYPAD_SAR05 < ((255ul*206)/330)? FALSE : TRUE)
#define Init_hw_DP2_GNDPin()            (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT5))
#define DC_DPCable_DET_DP2_SAR          SAR5_EN
...
#define DPRx_C2_AUX					AUX_GPIO_52_53_54
