...
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT1), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT1), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT1)) // output enable

#define hw_SetPanel()           MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT0)
#define hw_ClrPanel()           MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT0)
#define Init_hwPanel_Pin()      (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT0)) // output enable
...
#else
#define hwDSUBCable_Pin                 (_bit0_(MEM_MSREAD_BYTE(_REG_GPIO0_IN)))  //SAR3
...
#define hwSDM_AuxN_DP1Pin_Pin           (_bit2_(MEM_MSREAD_BYTE(_REG_GPIO3_IN))) // detect AUX_N
#define Init_hw_DP1_SDMPin()		    (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, 1, BIT2))
