#ifndef __BD_MTV19072__
#define __BD_MTV19072__
...
#define Input_Displayport_C1    Input_Digital
#define Input_Displayport_C2    Input_Nothing
#define Input_Displayport_C3    Input_Nothing
#define Input_Displayport_C4    Input_Digital4
...
#define CInput_Displayport_C1   CInput_Digital
#define CInput_Displayport_C2   CInput_Nothing
#define CInput_Displayport_C3   CInput_Nothing
#define CInput_Displayport_C4   CInput_Digital4
...
#define PM_POWERKEY_WAKEUP      (GPIO21_INT | GPIO20_INT | GPIO25_INT | GPIO26_INT | GPIO00_INT | GPIO01_INT | GPIO24_INT | GPIO27_INT | GPIO30_INT | GPIO31_INT | GPIO36_INT | GPIO37_INT | GPIO02_INT | GPIO11_INT | GPIO50_INT |GPIO51_INT)
...
#define hwBlacklit_Pin          //GPIOL7  //Driving Non-LED BL Module
#define hwPanel_Pin             //GPIO00
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIOL0_OEZ, 0, BIT7), MEM_MSWRITE_BIT(_REG_GPIOL0_OUT, BIT7, BIT7), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIOL0_OEZ, 0, BIT7), MEM_MSWRITE_BIT(_REG_GPIOL0_OUT, 0, BIT7), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIOL0_OEZ, 0, BIT7), MEM_MSWRITE_BIT(_REG_GPIOL0_OEZ, BIT7, BIT7))
...
#define hwDVI1Cable_Pin                 (!((((((255ul*210)/330) < KEYPAD_SAR07) && (KEYPAD_SAR07 < ((255ul*250)/330))) || (KEYPAD_SAR07 < ((255ul*180)/330)))?TRUE:FALSE))
...
#define hwDVI2Cable_Pin                 (!((KEYPAD_SAR07 < ((255ul*210)/330))?TRUE:FALSE))
#define Init_hwDVI2Cable_Pin()          (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT7))
...
#define hwSDM_AuxN_DP0Pin_Pin           (KEYPAD_SAR05 >= ((255ul*200)/330)? TRUE : FALSE)  // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP0_SDMPin()            MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT5)
#define DC_SDM_DET_DP0_SAR              SAR5_EN
#define hwGNDDP0_Pin                    ((((KEYPAD_SAR08 > ((255ul*206)/330)) && (KEYPAD_SAR08 < ((255ul*271)/330))) || (KEYPAD_SAR08 < ((255ul*172)/330)))? FALSE : TRUE)
#define Init_hw_DP0_GNDPin()            (MEM_MSWRITE_BIT(REG_003A69, TRUE, BIT0))
#define DC_DPCable_DET_DP0_SAR          SAR8_EN
#define Init_hw_DP0_PWRPin()            (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT0))
#else
...
#define hwSDM_AuxN_DP3Pin_Pin           (GETBIT(msReadByte(_REG_GPIO_DPC_IN), 0)) // PAD_GPIO_DPC0, For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP3_SDMPin()            (msWriteByteMask(_REG_GPIO_DPC_OEZ, BIT0, BIT0)) //PAD_GPIO_DPC0 OEN control
#define DC_SDM_DET_DP3_SAR              0
#define hwGNDDP3_Pin                    (KEYPAD_SAR08 < ((255ul*206)/330)? FALSE : TRUE)
#define Init_hw_DP3_GNDPin()            (MEM_MSWRITE_BIT(REG_003A69, TRUE, BIT0))
#define DC_DPCable_DET_DP3_SAR          SAR8_EN
#define Init_hw_DP3_PWRPin()            (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, TRUE, BIT2))
#else
...
#define CABLE_DET_SAR_EN                (CABLE_DET_VGA_SAR|DC_SDM_DET_DP0_SAR|DC_DPCable_DET_DP0_SAR|DC_DPCable_DET_DP3_SAR)
#define CABLE_DET_SAR                   0
#define CABLE_DET_SAR2_EN               (CABLE_DET_DVI0_SAR|CABLE_DET_DVI1_SAR|CABLE_DET_DVI2_SAR|CABLE_DET_DVI3_SAR|DC_SDM_DET_DP0_SAR|DC_DPCable_DET_DP0_SAR|DC_DPCable_DET_DP3_SAR)
...
#define ENABLE_SPDIF                    (1 && ENABLE_DAC)
...
#define HDMI_Rx1               HDMI_DDC_0
#define HDMI_Rx2               HDMI_DDC_2
...
#define HDMI_Cable5v_2        1
        ...
        #define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(REG_PAD_TOP_18_L, FALSE, BIT6), MEM_MSWRITE_BIT(REG_PAD_TOP_19_L, TRUE, BIT6))
        #define hw_Clr_HdcpHpd2()       (MEM_MSWRITE_BIT(REG_PAD_TOP_18_L, FALSE, BIT6), MEM_MSWRITE_BIT(REG_PAD_TOP_19_L, FALSE, BIT6))
        #define hwHDCP_Hpd2_Pin()       (MEM_MSREAD_BYTE(REG_PAD_TOP_19_H) & BIT6)
        #define hw_Set_HdcpHpd3()       (MEM_MSWRITE_BIT(REG_PAD_TOP_1D_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_1D_H, TRUE, BIT2))
        #define hw_Clr_HdcpHpd3()       (MEM_MSWRITE_BIT(REG_PAD_TOP_1D_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_1D_H, FALSE, BIT2))
        #define hwHDCP_Hpd3_Pin()       (MEM_MSREAD_BYTE(REG_PAD_TOP_1E_L) & BIT2)
    #else
        #define hw_Set_HdcpHpd()
        #define hw_Clr_HdcpHpd()
        #define hwHDCP_Hpd_Pin()
        #define hw_Set_HdcpHpd2()       (MEM_MSWRITE_BIT(REG_PAD_TOP_18_L, FALSE, BIT6), MEM_MSWRITE_BIT(REG_PAD_TOP_19_L, FALSE, BIT6))
        #define hw_Clr_HdcpHpd2()       (MEM_MSWRITE_BIT(REG_PAD_TOP_18_L, FALSE, BIT6), MEM_MSWRITE_BIT(REG_PAD_TOP_19_L, TRUE, BIT6))
        #define hwHDCP_Hpd2_Pin()       (!(MEM_MSREAD_BYTE(REG_PAD_TOP_19_H) & BIT6))
        #define hw_Set_HdcpHpd3()       (MEM_MSWRITE_BIT(REG_PAD_TOP_1D_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_1D_H, FALSE, BIT2))
        #define hw_Clr_HdcpHpd3()       (MEM_MSWRITE_BIT(REG_PAD_TOP_1D_L, FALSE, BIT2), MEM_MSWRITE_BIT(REG_PAD_TOP_1D_H, TRUE, BIT2))
        #define hwHDCP_Hpd3_Pin()       (!(MEM_MSREAD_BYTE(REG_PAD_TOP_1E_L) & BIT2))
    #endif
    #define Init_hwHDCP_Hpd_Pin()
    #define Init_hwHDCP_Hpd_Pin2()      (MEM_MSWRITE_BYTE_MASK(REG_PAD_TOP_31_L,0,BIT2|BIT1|BIT0), MEM_MSWRITE_BYTE_MASK(REG_PAD_TOP_4B_L, BIT6|BIT7, BIT6|BIT7))
    #define Init_hwHDCP_Hpd_Pin3()      (MEM_MSWRITE_BYTE_MASK(REG_PAD_TOP_31_L,0,BIT2|BIT1|BIT0), MEM_MSWRITE_BIT(REG_PAD_TOP_0C_L, FALSE, BIT1), MEM_MSWRITE_BIT(REG_PAD_TOP_0C_H, FALSE, BIT1), MEM_MSWRITE_BIT(REG_PAD_TOP_0B_H, FALSE, BIT1), MEM_MSWRITE_BYTE_MASK(REG_PAD_TOP_4C_L, BIT6|BIT7, BIT6|BIT7))
#else
    #define hw_Set_HdcpHpd()
    #define hw_Clr_HdcpHpd()
...
#define hw_SetUSB5V()               (MEM_MSWRITE_BIT(_REG_GPIOSAR_OUT, TRUE, BIT6), MEM_MSWRITE_BIT(_REG_GPIOSAR_OEZ, FALSE, BIT2))    //SAR2 as USB_OTG_EN
...
#define DPRx_C1_AUX					AUX_GPIO_31_32_33
#define DPRx_C2_AUX					AUX_None
#define DPRx_C3_AUX					AUX_None
#define DPRx_C4_AUX					AUX_GPIO_DPC_3_4_5

#define SET_DPC_PORT_AS_DP_PORT		1 // If CInput_Displayport_C4 is not equal to CInput_Nothing, this should set to 1
