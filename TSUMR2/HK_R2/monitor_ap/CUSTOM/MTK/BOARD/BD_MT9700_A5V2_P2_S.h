...
#define hwSDM_AuxN_DP1Pin_Pin           (KEYPAD_SAR06 >= ((255ul*200)/330)? TRUE : FALSE)  // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP1_SDMPin()            MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT6)
#define DC_SDM_DET_DP1_SAR              SAR6_EN
