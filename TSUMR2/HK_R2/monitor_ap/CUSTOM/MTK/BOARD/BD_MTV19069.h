...
#define hwSDM_AuxN_DP2Pin_Pin           (GETBIT(msReadByte(_REG_GPIO2_IN), 6))  // PAD_GPIO26, for Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP2_SDMPin()            (msWriteByteMask(_REG_GPIO2_OEZ, BIT6, BIT6)) // PAD_GPIO26 OEN control
#define hwGNDDP2_Pin                    (!((KEYPAD_SAR07 < ((255ul*180)/330))?TRUE:FALSE))
...
#define HDMI_Cable5v_2        1
        ...
        #define hwHDCP_Hpd_Pin2()       (MEM_MSREAD_BYTE(REG_PAD_TOP_19_H) & BIT1)
        #define hw_Set_HdcpHpd3()
        #define hw_Clr_HdcpHpd3()
        #define hwHDCP_Hpd_Pin3()
    #else
        #define hw_Set_HdcpHpd()
        #define hw_Clr_HdcpHpd()
        #define hwHDCP_Hpd_Pin()
...
#define Init_TYPEC_B_AUX_P()                 MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT5)
...
#define Init_TYPEC_B_AUX_N()              MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT0)
