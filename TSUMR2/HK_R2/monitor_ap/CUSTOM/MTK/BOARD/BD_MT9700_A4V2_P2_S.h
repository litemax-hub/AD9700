#ifndef __BD_MTV19069__
#define __BD_MTV19069__
...
#define DFT_MUX_Uart1           UART_GPIO_RESERVED
#define SERIAL_BAUD_RATE        115200
#define SERIAL_BAUD_RATE_PM     9600

#define ENABLE_INTERNAL_CC      (1&ENABLE_USB_TYPEC)
...
#define Input_Displayport_C3    Input_Digital2
#define Input_Displayport_C4    Input_Nothing
#define Input_UsbTypeC_C3       Input_Nothing
#define Input_UsbTypeC_C4       Input_Digital3
...
#define CInput_Displayport_C3   CInput_Digital2
#define CInput_Displayport_C4   CInput_Nothing
#define CInput_UsbTypeC_C3      CInput_Nothing
#define CInput_UsbTypeC_C4      CInput_Digital3
...
#define DDC_Port_D3             ((CInput_DVI_C4!=CInput_Nothing) || (CInput_HDMI_C4!=CInput_Nothing))
#define DDC_Port_D4             (USB_HUB)
...
#define BACKLIGHT_PWM_FREQ                  22000//240         //unit:Hz
...
#define PM_POWERKEY_WAKEUP      (GPIO21_INT | GPIO20_INT | GPIO25_INT | GPIO26_INT | GPIO00_INT | GPIO01_INT | GPIO24_INT | GPIO27_INT | GPIO30_INT | GPIO31_INT | GPIO02_INT | GPIO11_INT | GPIO50_INT |GPIO51_INT)

//================================================================================================================
//================================================================================================================
// 1.Write protection:
#define hwDDC_WP_Pin            //Pull to Ground in Schematic
#define hwEEPROM_WP             //no GPIO assigned
...
#define hwBlacklit_Pin          //GPIO25  //Driving Non-LED BL Module
#define hwPanel_Pin             //GPIOL7
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT5), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, BIT5, BIT5), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT5), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT5), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT5), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, BIT5, BIT5))

#define hw_SetPanel()           MEM_MSWRITE_BIT(_REG_GPIOL0_OUT, 1, BIT7)
#define hw_ClrPanel()           MEM_MSWRITE_BIT(_REG_GPIOL0_OUT, 0, BIT7)
#define Init_hwPanel_Pin()      MEM_MSWRITE_BIT(_REG_GPIOL0_OEZ, 0, BIT7)
...
#define CABLE_DET_VGA_SAR               0 //GPIO00 no SAR function
#else
#define hwDSUBCable_Pin                 0
#define Init_hwDSUBCable_Pin()
...
#if (CInput_HDMI_C1!=CInput_Nothing)||(CInput_DVI_C1!=CInput_Nothing)||(CInput_DualDVI_C1!=CInput_Nothing)   // Digital Input Port 0
...
#if (CInput_HDMI_C2!=CInput_Nothing)||(CInput_DVI_C2!=CInput_Nothing)||(CInput_DualDVI_C2!=CInput_Nothing)   // Digital Input Port 1
#define hwDVI1Cable_Pin                 (!((((((255ul*180)/330) < KEYPAD_SAR07) && (KEYPAD_SAR07 < ((255ul*220)/330))) || (KEYPAD_SAR07 < ((255ul*145)/330)))?TRUE:FALSE))
#define Init_hwDVI1Cable_Pin()          (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT7))
#define CABLE_DET_DVI1_SAR              SAR7_EN
#else
...
#define hwSDM_AuxN_DP2Pin_Pin           (KEYPAD_SAR04 >= ((255ul*200)/330)? TRUE : FALSE)  // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP2_SDMPin()            MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT4)
#define DC_SDM_DET_DP2_SAR				SAR4_EN
#define hwGNDDP2_Pin                    (((KEYPAD_SAR07 < ((255ul*245)/330)))? FALSE : TRUE)
#define Init_hw_DP2_GNDPin()            (MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT7))
#define DC_DPCable_DET_DP2_SAR          SAR7_EN
#define Init_hw_DP2_PWRPin()            (MEM_MSWRITE_BIT(_REG_GPIO5_OEZ, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO5_OUT, TRUE, BIT1))
#else
#define hwSDM_AuxN_DP2Pin_Pin           0
#define Init_hw_DP2_SDMPin()            0
#define hwGNDDP2_Pin                    0
#define Init_hw_DP2_GNDPin()            0
...
#define hwSDM_AuxN_TYPEC4Pin_Pin        (GETBIT(msReadByte(REG_000492), 5)) // For Aux N detect, TRUE: connected, FALSE: not connected
#define hwSDM_AuxP_TYPEC4Pin_Pin        (GETBIT(msReadByte(REG_000492), 0)) // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_TYPEC4_SDMPin()
#define DC_SDM_DET_TYPEC4_SAR           0 //GPIO00 no SAR function
#else
...
#define CABLE_DET_SAR2_EN               (CABLE_DET_DVI0_SAR|CABLE_DET_DVI1_SAR|CABLE_DET_DVI2_SAR|CABLE_DET_DVI3_SAR)\
                                        |(DC_SDM_DET_DP2_SAR|DC_DPCable_DET_DP0_SAR|DC_DPCable_DET_DP1_SAR|DC_DPCable_DET_DP2_SAR|DC_DPCable_DET_DP3_SAR)\
                                        |(DC_SDM_DET_TYPEC3_SAR|DC_SDM_DET_TYPEC4_SAR)

//================================================================================================================
//================================================================================================================
// 5.Led
#define hwGreenLed_Pin                  // GPIO23
#define hwAmberLed_Pin                  // GPIO22

#define hw_SetGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT3);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT3);}
#define hw_ClrGreenLed()                {MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT3);MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT3);}
...
#if ENABLE_SPDIF
#define Init_Pin_SPDIF()		        (MEM_MSWRITE_BIT(REG_000406,BIT1,BIT1))
#else
...
#define HDMI_Cable5v_2        1
        ...
        #define hwHDCP_Hpd2_Pin()       (MEM_MSREAD_BYTE(REG_PAD_TOP_19_H) & BIT1)
...
#if HDMI_PRETEST
#define Init_hwCEC_Pin()            //(_MEM_MSWRITE_BIT(REG_0262, TRUE, BIT0))
#endif
...
//================================================================================================================
// TYPE C
//Internal CC board. Different control than external CC
#define hw_Set_TYPEC_A_AUX_P()           //(MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT5), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT4), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT5)) //PE = 0x1, PS = 0x1
#define hw_Clr_TYPEC_A_AUX_P()           //(MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT5), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT4), MEM_MSWRITE_BIT(REG_000496, FALSE, BIT5)) //PE = 0x1, PS = 0x0
#define Init_TYPEC_A_AUX_P()             //(MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT5))

#define hw_Set_TYPEC_A_AUX_N()           //(MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT0), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT3)) //PE = 0x1, PS = 0x1
#define hw_Clr_TYPEC_A_AUX_N()           //(MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT0), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000496, FALSE, BIT3)) //PE = 0x1, PS = 0x0
#define Init_TYPEC_A_AUX_N()             //(MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT0))

#define hw_Set_TYPEC_A_AUX_TRI()           	//(MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, TRUE, BIT1))
#define hw_Clr_TYPEC_A_AUX_TRI()           	//(MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, FALSE, BIT1))
#define Init_TYPEC_A_AUX_TRI()          	//(MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, FALSE, BIT1))  //set output mode, set Low

#define hw_Set_TYPEC_B_AUX_P()           (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT5), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT4), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT5))  // PE = 0x1, PS = 0x1
#define hw_Clr_TYPEC_B_AUX_P()           (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT5), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT4), MEM_MSWRITE_BIT(REG_000496, FALSE, BIT5)) // PE = 0x1, PS = 0x0
#define Init_TYPEC_B_AUX_P()             (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, FALSE, BIT5), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT5))

#define hw_Set_TYPEC_B_AUX_N()           (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT0), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT3))  // PE = 0x1, PS = 0x1
#define hw_Clr_TYPEC_B_AUX_N()           (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, TRUE, BIT0), MEM_MSWRITE_BIT(REG_000496, TRUE, BIT2), MEM_MSWRITE_BIT(REG_000496, FALSE, BIT3)) // PE = 0x1, PS = 0x0
#define Init_TYPEC_B_AUX_N()             (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT0))

#define hw_Set_TYPEC_B_AUX_TRI()         (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO50_OEZ, TRUE, BIT7))
#define hw_Clr_TYPEC_B_AUX_TRI()         (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, TRUE,, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO50_OEZ, FALSE, BIT7))
#define Init_TYPEC_B_AUX_TRI()           (MEM_MSWRITE_BIT(_REG_GPIO_DPC_OUT, TRUE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_DPC_OEZ, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO50_OUT, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO50_OEZ, FALSE, BIT7)) // Set output mode, set Low

#define hw_Set_Hub_Vbus()                 //(MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, FALSE, BIT2))
#define hw_Clr_Hub_Vbus()                 //(MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, TRUE, BIT2))
#define Init_Hub_Vbus()                   //(MEM_MSWRITE_BIT(_REG_GPIO_X3_OUT, FALSE, BIT2), MEM_MSWRITE_BIT(_REG_GPIO_X3_OEZ, TRUE, BIT2))

#define hw_SetUSB5V()

#if ENABLE_VBUS_DETECT_SAR
#define VBUS_DET_SAR_CH                   SAR2_EN // SAR0~SAR3, must sync to PD code
#else
...
#define DPRx_C3_AUX					AUX_GPIO_52_53_54 //For 02 settings, this suould set to AUX_None
#define DPRx_C4_AUX					AUX_GPIO_DPC_3_4_5
