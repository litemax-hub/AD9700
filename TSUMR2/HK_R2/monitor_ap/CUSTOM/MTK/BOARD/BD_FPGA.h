...
#define MCU_SPEED_INDEX         IDX_MCU_CLK_216MHZ
...
//PWM
#define BrightnessPWM           _PWM8_GP1_          // driving Non-LED BL Module
#define Init_BrightnessPWM()    (MEM_MSWRITE_BYTE_MASK(REG_00040D,BIT0,BIT0), MEM_MSWRITE_BYTE_MASK(REG_000581,BIT4,BIT4))
...
#define hwBlacklit_Pin          //GPIO22  //Driving Non-LED BL Module
#define hwPanel_Pin             //GPIO_X21
#define hw_SetBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT2), MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT2), BackLightActiveFlag=1)
#define hw_ClrBlacklit()        (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 1, BIT2), BackLightActiveFlag=0)
#define Init_hwBlacklit_Pin()   (MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT2), MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0, BIT0))

#define hw_SetPanel()           //MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, 1, BIT1)
#define hw_ClrPanel()           //MEM_MSWRITE_BIT(_REG_GPIO_X2_OUT, 0, BIT1)
#define Init_hwPanel_Pin()      //MEM_MSWRITE_BIT(_REG_GPIO_X2_OEZ, 0, BIT1)
...
#define hwDVI0Cable_Pin                 //(!_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X0_IN)))
#define Init_hwDVI0Cable_Pin()          //(MEM_MSWRITE_BIT(_REG_GPIO_X0_OEZ, TRUE, BIT1))
...
#define hwSDM_AuxN_DP1Pin_Pin           (KEYPAD_SAR08>=((255ul*200)/330)?TRUE:FALSE)     // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP1_SDMPin()            MEM_MSWRITE_BIT(REG_003A69, TRUE, BIT0)
#define DC_SDM_DET_DP1_SAR              SAR8_EN
#define hwGNDDP1_Pin				    0//(_bit1_(MEM_MSREAD_BYTE(_REG_GPIO_X1_IN)))
#define Init_hw_DP1_GNDPin()		    0//(MEM_MSWRITE_BIT(_REG_GPIO_X1_OEZ, TRUE, BIT1))
...
#define CABLE_DET_SAR2_EN               (CABLE_DET_DVI0_SAR|CABLE_DET_DVI1_SAR|CABLE_DET_DVI2_SAR|CABLE_DET_DVI3_SAR)\
										|(DC_SDM_DET_DP0_SAR|DC_SDM_DET_DP1_SAR|DC_SDM_DET_DP2_SAR|DC_SDM_DET_DP3_SAR)\
                                        |(DC_SDM_DET_TYPEC3_SAR|DC_SDM_DET_TYPEC4_SAR)

//================================================================================================================
//================================================================================================================
// 5.Led
#define hwGreenLed_Pin                  //no GPIO assigned
#define hwAmberLed_Pin                  //no GPIO assigned

#define hw_SetGreenLed()                //{_MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2);_MEM_MSWRITE_BIT(_REG_GPIO2_OUT,1,BIT2);}
#define hw_ClrGreenLed()                //{_MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT2);_MEM_MSWRITE_BIT(_REG_GPIO2_OUT,0,BIT2);}
#define Init_hwGreenLed_Pin()           //_MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0,BIT2)// output enable

#define hw_SetAmberLed()                //{_MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT3);_MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 0, BIT3);}
#define hw_ClrAmberLed()                //{_MEM_MSWRITE_BIT(_REG_GPIO2_OEZ,0,BIT3);_MEM_MSWRITE_BIT(_REG_GPIO2_OUT, 1, BIT3);}
#define Init_hwAmberLed_Pin()           //_MEM_MSWRITE_BIT(_REG_GPIO2_OEZ, 0,BIT3)// output enable
...
#define ENABLE_I2S                      (1 && ENABLE_DAC)
...
#define HDMI_Cable5v_0        0 //there is no GPIO_Cable5v connect to IC
#define HDMI_Cable5v_1        1
#define HDMI_Cable5v_2        1

#if ENABLE_HDCP
#define hw_Set_HdcpHpd()            (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, TRUE, BIT6))
#define hw_Clr_HdcpHpd()            (MEM_MSWRITE_BIT(_REG_GPIO3_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT6))
...
#if ENABLE_DP_OUTPUT
#define NONE                        0x00
#define	DPTX_GPIOX_20               0x01
#define	DPTX_GPIO23                 0x02
#define DPTX_PS_CTRL                DPTX_GPIOX_20
#endif
...
//================================================================================================================
// TYPE C
#define hw_Set_TYPEC_A_AUX_P()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT0))
#define hw_Clr_TYPEC_A_AUX_P()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT0))
#define Init_TYPEC_A_AUX_P()             //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT0), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT0))

#define hw_Set_TYPEC_A_AUX_N()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT1))
#define hw_Clr_TYPEC_A_AUX_N()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT1))
#define Init_TYPEC_A_AUX_N()             //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT1))
...
#define hw_Set_TYPEC_B_AUX_P()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT6))
#define hw_Clr_TYPEC_B_AUX_P()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT6))
#define Init_TYPEC_B_AUX_P()             //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT6), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT6))

#define hw_Set_TYPEC_B_AUX_N()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, TRUE, BIT7))
#define hw_Clr_TYPEC_B_AUX_N()           //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT7))
#define Init_TYPEC_B_AUX_N()             //(MEM_MSWRITE_BIT(_REG_GPIO0_OUT, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO0_OEZ, FALSE, BIT7))

#define hw_Set_TYPEC_B_AUX_TRI()         //(MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, TRUE, BIT1))
#define hw_Clr_TYPEC_B_AUX_TRI()         //(MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT1))
#define Init_TYPEC_B_AUX_TRI()           //(MEM_MSWRITE_BIT(_REG_GPIO_X4_OUT, FALSE, BIT1), MEM_MSWRITE_BIT(_REG_GPIO_X4_OEZ, FALSE, BIT1))  //set output mode, set Low
