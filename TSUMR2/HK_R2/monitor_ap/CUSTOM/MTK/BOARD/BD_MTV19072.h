...
#define hwSDM_AuxN_DP0Pin_Pin           (KEYPAD_SAR06 >= ((255ul*200)/330)? TRUE : FALSE)  // For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP0_SDMPin()            MEM_MSWRITE_BIT(REG_003A68, TRUE, BIT6)
#define DC_SDM_DET_DP0_SAR              SAR6_EN
...
#define Init_hw_DP0_PWRPin()            (MEM_MSWRITE_BIT(_REG_GPIO3_OEZ, FALSE, BIT7), MEM_MSWRITE_BIT(_REG_GPIO3_OUT, TRUE, BIT7))
#else
...
#define hwSDM_AuxN_DP3Pin_Pin           (GETBIT(msReadByte(_REG_GPIO_DPC_IN), 0)) // PAD_GPIO_DP01, For Aux N detect, TRUE: connected, FALSE: not connected
#define Init_hw_DP3_SDMPin()            (msWriteByteMask(_REG_GPIO_DPC_OEZ, BIT0, BIT0)) //PAD_GPIO_DP01 OEN control
