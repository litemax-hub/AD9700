...
/// @param  s32PoolId   \b IN: memory pool ID (not used in non-OS version)
/// @return NULL : not enough available memory
/// @return Otherwise : pointer to the allocated memory block
//-------------------------------------------------------------------------------------------------
#if 0
void * MsOS_AllocateMemory (U32 u32Size)
{
#if 0
    void *ptr = dlmalloc(u32Size);
    ...
    return ptr;
    //return ( dlmalloc(u32Size) );
    //return ( memalign(16, u32Size) );
}
#endif
