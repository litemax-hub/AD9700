...
{
    mbedtls_memset( ctx, 0, sizeof(mbedtls_entropy_context) );
...
int mbedtls_entropy_func( void *data, unsigned char *output, size_t len )
{
    ...
    mbedtls_memset( buf, 0, MBEDTLS_ENTROPY_BLOCK_SIZE );
     ...
     */
    mbedtls_memset( &ctx->accumulator, 0, sizeof( mbedtls_sha512_context ) );
    mbedtls_sha512_starts( &ctx->accumulator, 0 );
     ...
     * Reset accumulator and counters and recycle existing entropy
     */
    mbedtls_memset( &ctx->accumulator, 0, sizeof( mbedtls_sha256_context ) );
    mbedtls_sha256_starts( &ctx->accumulator, 0 );
                                 ...
                                 size_t len, size_t *olen )
{
    ...
    mbedtls_memset( output, 0x2a, len );
    *olen = len;
