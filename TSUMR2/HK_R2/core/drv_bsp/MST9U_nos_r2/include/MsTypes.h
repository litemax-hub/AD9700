...
typedef enum
{
    ...
    E_MS_FMT_BGRA8888               = 0x1e, // 0x1f for MST9U4  
    /// color format ABGR8888
    E_MS_FMT_ABGR8888               = 0x1f, // 0x1e for MST9U4
